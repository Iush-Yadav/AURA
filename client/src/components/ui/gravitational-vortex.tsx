...
function __OriginkitBase_GravitationalVortex(props: GravitationalVortexProps) {
    const {
        background = "#000000",
        backgroundColor,
        baseColor = "#0FFF00",
...
export default function GravitationalVortex(props: Record<string, unknown>) {
  return <__OriginkitBase_GravitationalVortex {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
